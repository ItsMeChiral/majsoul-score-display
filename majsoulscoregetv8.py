...
def getscorefromscreenshot(rotation,image,file):
    screenshotconfirm=1
    while screenshotconfirm==1:
        try:
           im1=pyautogui.screenshot(region=image)
           toimen=im1.rotate(rotation,expand=True)
           toimen=toimen.save(file)
           toimen=pytesseract.image_to_string(file,config='digits')
...
while getstarted==1:
    ...
    while sumcheck==0:
        finalscores=[]
        getscorefromscreenshot(0,(900,460,130,50),savelocation)
        getscorefromscreenshot(270,(1024,360,50,130),savelocation)
        getscorefromscreenshot(180,(890,340,120,50),savelocation)
        getscorefromscreenshot(90,(855,360,50,130),savelocation)
